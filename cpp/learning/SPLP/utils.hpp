...
cv::Mat compute_spatial_relation_feature(const learning::splp::Detection& d1, const learning::splp::Detection& d2, float patch_size);
...
void nms(std::vector<learning::splp::Detection>& src,
          std::vector<learning::splp::Detection>& dst,
          float thresh);
